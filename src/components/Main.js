          ...
          <Col lg={6}>
            <Carousel>
              <Carousel.Item interval={3000}>
                ...
                <Carousel.Caption>
                  <span className='fw-bold text-black bg-white h3 mb-5 rounded p-1 ubuntu-regular '> Fried Rice </span>
                  <br />
              ...
              <Carousel.Item interval={3000}>
                ...
                <Carousel.Caption>
                  <span className='fw-bold text-black bg-white h3 mb-5 rounded p-1 ubuntu-regular'> Tandoor Chicken </span>
              ...
              <Carousel.Item interval={3000}>
                ...
                <Carousel.Caption>
                  <span className='fw-bold text-black bg-white h3 mb-5 rounded p-1 ubuntu-regular'>Parotha with Tikka</span>
